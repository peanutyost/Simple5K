...
def generate_race_report(filename, race_data, return_type):
    ...
    def draw_box(canvas_obj, x, y, width, height, text_lines, top_padding=0.2 * inch):
        ...
        Args:
            ...
            x: The x-coordinate of the bottom-left corner of the box.
            y: The y-coordinate of the bottom-left corner of the box.
            width: The width of the box.
            height: The height of the box.
            text_lines: A list of strings (lines of text) to draw in the box.
            top_padding: The amount of space (in inches) to add at the top
                        of the box before the first line of text.
        """
