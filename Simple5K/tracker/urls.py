...
urlpatterns = [
    ...
    path('pay/<int:runner_id>/<str:signature>/', pay_entry, name='pay-entry'),
    path('settings/', site_settings_view, name='site-settings'),
    path('banners/', banner_list, name='banner-list'),
    path('banners/add/', banner_create, name='banner-create'),
    path('banners/<int:pk>/edit/', banner_edit, name='banner-edit'),
    path('banners/<int:pk>/delete/', banner_delete, name='banner-delete'),
